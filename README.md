Goal is to have all the plumbing in place to get a node app up and running. Only "overkill" IMHO dependency is a templating language (handlebars) for rendering html
